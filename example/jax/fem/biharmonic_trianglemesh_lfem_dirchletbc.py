...
from fealpy.jax.fem.scalar_biharmonic_integrator import ScalarBiharmonicIntegrator
from fealpy.jax.fem.scalar_interior_penalty_integrator import ScalarInteriorPenaltyIntegrator
