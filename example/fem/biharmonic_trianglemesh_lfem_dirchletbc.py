...
Rhu = np.zeros((maxit, len(node0), GD, GD), dtype=np.float64)
gx0 = np.zeros((len(node0), GD), dtype=np.float64)
hx0 = np.zeros((len(node0), GD, GD), dtype=np.float64)
Rhu00 = np.zeros(maxit, dtype=np.float64)
